define([
	...
	var DashView = Backbone.View.extend({
		...
		html: [
			'<h3>Home - Created by Reyhaneh</h3>',
			'<h4>Please be aware this app is using a free version of www.wunderground.com API and the limitation is 10 request per 10 minutes.</h4>',
